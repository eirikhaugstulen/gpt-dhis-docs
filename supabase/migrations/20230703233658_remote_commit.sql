...
--
-- Name: match_documents("public"."vector", integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "match_documents"("query_embedding" "public"."vector", "match_count" integer); Type: ACL; Schema: public; Owner: postgres
--
