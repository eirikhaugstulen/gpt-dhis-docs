                    ...
                    <div className="transform overflow-hidden flex flex-col gap-5 px-6 py-10 rounded bg-white ">
                        ...
                        <div className={'max-w-3xl w-full mx-auto'}>
                            <ChatMessages
                                ...
                                defaultText={'Hello! I am a DHIS2 assistant that is connected to your specific instance. Start by writing **Get programs** 👋'}
                            />
                        </div>
